    ...
    <div class="container">
      ...
      <div class="row content">
        ...
        <div class="col-lg-6 pt-4 pt-lg-0" data-aos="fade-left" data-aos-delay="200">
          <h1>About Us</h1>
          <p class="fst-italic">
            RGI EXPERT SOLUTIONS, India's largest influencer ID Cards and Printing Products, is all about providing an
            inspired,
          ...
          <div class="row">
            ...
            <div class="col-md-6 d-flex align-items-stretch mt-4">
              <div class="icon-box" data-aos="zoom-in" data-aos-delay="400">
                ...
                <h4><a href="{{route('show_category',['id'=>$categories->id])}}">{{$categories->name}}</a></h4>
          ...
          <div class="portfolio-wrap">
            ...
            <div class="portfolio-info">
              ...
              <div class="portfolio-links">
                <a href="{{$products->image}}" data-gallery="portfolioGallery" class="portfolio-lightbox"
                  title="{{$products->title}}"><i class="bx bx-plus"></i></a>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-4">
          <div class="section-title" data-aos="fade-right">
            <h2>Testimonials</h2>
            <p>Magnam dolores commodi suscipit uisquam quos quisquam cupiditate. Et nemo qui impedit suscipit alias ea.
