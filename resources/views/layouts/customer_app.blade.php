...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            @if (isset($customer400)&&$customer400 == "accepted")
            <li class="nav-item">
                ...
                <div id="collapseSix" class=" collapse" aria-labelledby="headingThree" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{route('add_customer_product')}}">Add Product</a>
                        <a class="collapse-item" href="{{route('customer_product')}}">Show Product</a>
                    </div>
                </div>
            </li>
            <li class="nav-item">
                ...
                <div id="collapseSeven" class=" collapse" aria-labelledby="headingThree"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{route('add_delivery')}}">Add Delivery Address</a>
                        <a class="collapse-item" href="{{route('delivery')}}">Show Delivery Address</a>
                    </div>
                </div>
            </li>
            @endif
