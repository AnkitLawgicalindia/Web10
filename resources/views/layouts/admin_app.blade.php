...
<head>
    ...
    <title>Rgi Expert Solution</title>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{route('index')}}">
                ...
                <div class="sidebar-brand-text mx-3">Rgi Expert Solution</div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseFour" class=" collapse" aria-labelledby="headingThree" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{route('show_mail')}}">Mail</a>
                    </div>
                </div>
            </li>
            <li class="nav-item">
                ...
                <div id="collapseFive" class=" collapse" aria-labelledby="headingThree" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Designs</h6>
                        <a class="collapse-item" href="{{route('add_designs')}}">Add Designs</a>
                        <a class="collapse-item" href="{{route('designs')}}">Show Designs</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseSix" class=" collapse" aria-labelledby="headingThree" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{route('customers')}}">Show Customer</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseSeven" class=" collapse" aria-labelledby="headingThree"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Customer Requirement</h6>
                        <a class="collapse-item" href="{{route('show_customer_requirement')}}">Customer
                            Requirement</a>
                    </div>
                </div>
            </li>
